...
def setup_training_loop_kwargs(
    ...
    args.G_kwargs = dnnlib.EasyDict(class_name='training.networks.Generator', z_dim=256, w_dim=256,
    ...
    args.D_kwargs.channel_max = 128
    args.G_kwargs.synthesis_kwargs.channel_max = 64
